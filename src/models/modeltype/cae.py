...
from src.config import MAE_MODEL_PATH, SMPLFACES_PATH
faces = np.load(SMPLFACES_PATH)
...
#        raster_settings = PointsRasterizationSettings(image_size=256, radius = 0.03, points_per_pixel = 10)
#        rasterizer = PointsRasterizer(cameras=cameras, raster_settings=raster_settings) 
#        self.renderer = PointsRenderer(rasterizer=rasterizer, compositor=AlphaCompositor(background_color=(1, 1, 1)) )
